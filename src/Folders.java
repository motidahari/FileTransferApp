...
public class Folders implements Runnable {
	...
	public static void runApp(String strOneDrive, String strGoogleDrive, String[] folders) {
		...
		for (int i = 0; i < folders.length; i++) {
			...
			if(checkIfFolderIsEmpty) {
				//String path = strGoogleDrive + folders[i2][i][j];
				...
				if(fileNames.length>0) {
					for (int k = 0; k < fileNames.length; k++) {
						...
						//System.out.println(Arrays.deepToString(fileNames2));
						...
						//System.out.println("b === " + newLocation);
	...
	public static String[] getAllFileNamesFromFolder(String path) {
		...
		for (int i = 0; i < listOfFiles.length; i++) {
			if (listOfFiles[i].isFile()) {
				if(!listOfFiles[i].getName().equals("desktop.ini")) {
	...
	public static String [] readStringFromFileAndAddItToArray(String path) {
		...
		//System.out.println("folders = " + Arrays.deepToString(arr));
		return arr;
	}
...
/*
		...
		System.out.println("pathforYoutube = " + pathforYoutube);
		System.out.println("strOneDrive = " + strOneDrive);
		System.out.println("strGoogleDrive = " + strGoogleDrive);
*/
